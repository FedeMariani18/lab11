...
final class TestMusicGroup {
    ...
    void testOrderedSongNames() {
        final List<String> result = Arrays.asList(new String[] { //NOPMD choose of the prof
                "Black Dog",
                "Dazed and Confused",
    ...
    void testAlbumInYear() {
        final List<String> result = Arrays.asList(new String[] { II, I }); //NOPMD choose of the prof
